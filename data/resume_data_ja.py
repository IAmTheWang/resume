"""日本語版サイトコンテンツ。resume_data_jp.py（私用リポジトリ）から抜粋し、
連絡先を公開用に減らしたもの（電話番号・詳細住所を除く）。
"""
...
SKILLS = [
    ...
    (
        "AI活用開発",
        "Cursor（2023年、中国での実務コード開発）；Claude、ChatGPT（2024年〜現在、日本）—— "
...
EXPERIENCE = [
    {
        ...
        "meta": "使用言語：日本語",
        "blurb": (
            "慢性疾患診療向けPHR（Personal Health Record）プラットフォーム。"
    ...
    },
    {
        ...
        "meta": "使用言語：日本語",
        "blurb": (
            "大手電力会社案件（業務委託）。顧客向け契約情報ポータルおよび社内契約管理システム。"
            "チーム規模15名。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": "使用言語：日本語",
        "blurb": (
            "同一の電力会社案件に正社員として従事。契約終了後は個人事業主として継続。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "製造業向け部品管理プラットフォームおよび教育市場向けOCR製品。チーム規模11名。上場企業。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "統計・地理空間データを可視化するモバイル・ブラウザ向け地図アプリケーション。"
            "チーム規模14名。上場企業。"
        ),
        "responsibilities": [
...
LANGUAGES = [
    ...
    (
        "就労資格",
        "技術・人文知識・国際業務ビザ（有効期限：2029年7月16日）。就労ビザのスポンサーシップ不要。",
    ),
]

PERSONAL_STATEMENT = (
    "フロントエンド開発を中心に7年の経験を積む中で、設計文書やテストコード、"
