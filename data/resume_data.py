"""Public resume site content — the single source of truth for both pages.

Trimmed from the private resume_data.py in the main resumes repo. Contact
info is intentionally reduced (no phone number, no street address) since
this file is rendered on a public web page.
"""
...
LINKEDIN_LABEL = "linkedin.com/in/hongcheng-wang-1597a6381"
LINKEDIN_URL = "https://linkedin.com/in/hongcheng-wang-1597a6381"

# --- Summary -------------------------------------------------------------------

SUMMARY = (
    "Frontend engineer with 7 years of experience building production web applications in "
...
SKILLS = [
    ...
    (
        "Frontend",
        "Vue 3 (Composition API, Pinia, Vue Router, vue-i18n), React, Next.js, Nuxt, "
        "Angular, Chart.js, Vite, Sass/SCSS",
    ),
    (
        "BFF / Server-Side",
        "Next.js (API Routes, App Router, Middleware), Nuxt 3 (Nitro Server Routes, "
        "Server Middleware), SSE streaming/proxying, service aggregation, server-side "
        "caching, data masking/DTO shaping",
    ),
    (
        "Cloud & DevOps",
        "AWS (S3, CloudFront, WAF, Route 53, IAM/OIDC), Terraform, CloudFormation, "
    ...
    (
        ...
        "Cursor (2023, production code in China); Claude, ChatGPT (2024–present, Japan) for "
...
EXPERIENCE = [
    {
        ...
        "blurb": (
            "Clinician-facing PHR (Personal Health Record) platform for chronic-disease care, "
    ...
    },
    {
        ...
        "meta": "Working language: Japanese",
        "blurb": (
            "Contracted to a major Japanese electric power utility — customer-facing contract "
    ...
    },
    {
        ...
        "meta": "Working language: Japanese",
        "blurb": (
            "Full-time employee on the same electric-utility engagement, continued afterward "
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "Manufacturing parts management platform, plus OCR products for the education "
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "Mobile and browser map applications visualizing statistical and geospatial data. "
...
PERSONAL_STATEMENT = (
    "I pair seven years of front-end development with a habit of writing things "
