"""中文版网站内容。从 resume_data_cn.py（私有仓库）裁剪而来，
联系方式做了脱敏（去掉电话号码和详细地址）。
"""
...
SKILLS = [
    ...
    (
        "AI辅助开发",
        "Cursor（2023年，中国期间生产代码开发）；Claude、ChatGPT（2024年至今，日本）"
...
EXPERIENCE = [
    {
        ...
        "meta": "工作语言：日语",
        "blurb": (
            "面向慢性病诊疗的PHR（个人健康档案）平台，基于Vue 3 + TypeScript的单页应用。"
            "东京证券交易所Growth市场上市公司。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": "工作语言：日语",
        "blurb": (
            "承接日本大型电力公司项目（业务委托形式）——面向客户的合同信息门户及"
            "公司内部合同管理系统。团队规模15人。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": "工作语言：日语",
        "blurb": (
            "以正式员工身份参与同一电力公司项目，合同结束后转为个人事业主（自由职业）"
            "继续该项目。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "面向制造业的零部件管理平台，及面向教育市场的OCR产品。团队规模11人；"
            "上市公司。"
        ),
        "responsibilities": [
    ...
    },
    {
        ...
        "meta": None,
        "blurb": (
            "面向统计与地理空间数据可视化的移动端与浏览器端地图应用。团队规模14人；"
            "上市公司。"
        ),
        "responsibilities": [
...
PERSONAL_STATEMENT = (
    "7年前端开发经验之外，我还积累了AWS交付基础设施搭建与AI辅助后端维护的实战经验，"
